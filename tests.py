...
args = ['python', 'brainx.py', '\"[-]\"', '-m', r"b'\x03\x02'", '-p', '1', '-t']
...
args = ['python', 'brainx.py', '"[[-]<]"', '-m', r"b'\x03\x03\x00\x02\x02'", '-p', '4', '-t']
p = subprocess.Popen(args, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
output, error = p.communicate()
print( "output:", output )
assert output.replace(b'\r', b'') == b''
...
args = ['python', 'brainx.py', '"[>]"', '-m', r"b'\x03\x03\x00\x02\x02'", '-t']
p = subprocess.Popen(args, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
output, error = p.communicate()
print( "output:", output )
assert output.replace(b'\r', b'') == b''
...
args = ['python', 'brainx.py', '"[>+<-]"', '-m', r"b'\x03\x03'", '-t']
p = subprocess.Popen(args, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
output, error = p.communicate()
print( "output:", output )
assert output.replace(b'\r', b'') == b''
...
args = ['python', 'brainx.py', '"[>-<-]"', '-m', r"b'\x03\x05'", '-t']
p = subprocess.Popen(args, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
output, error = p.communicate()
print( "output:", output )
assert output.replace(b'\r', b'') == b''
